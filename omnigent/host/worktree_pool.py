...
class WorktreePoolManager:
    ...
    def _finalize_branch_before_cleanup(self, lease: _Lease) -> None:
        ...
        # TODO: Generate an AI commit message from the staged diff and session
        # context before cleanup. Keep this deterministic fallback for offline
        # or model-failure cases so release can still preserve user work.
